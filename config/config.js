...
module.exports = {
  ...
  ocr: {
    ...
    modelId: process.env.OCR_MODEL_ID || 'zai-org/GLM-OCR',
    prompt: process.env.OCR_PROMPT || 'Text Recognition:',
    ...
    enableDeepseek: parseEnvBoolean(process.env.OCR_ENABLE_DEEPSEEK, 'no')
  },
